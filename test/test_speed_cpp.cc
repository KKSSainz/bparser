...
void test_expression(std::string filename)  {
	...
	for (uint i=0; i<block_sizes.size(); ++i) {
		uint id_counter = 0;
		test_expr("-v1", block_sizes[i], "TEST_" + std::to_string(id_counter++) + "_" + std::to_string(block_sizes[i]), file, &expr0);
		test_expr("v1 + v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr1);
		test_expr("v1 - v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr2);
		test_expr("v1 * v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr3);
		test_expr("v1 / v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr4);
		test_expr("v1 % v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr5);
		test_expr("(v1 == v2)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr6);
		test_expr("v1 != v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr7);
		test_expr("v1 < v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr8);
		test_expr("v1 <= v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr9);
		test_expr("v1 > v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr10);
		test_expr("v1 >= v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr11);
		test_expr("not (v1 == v2)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr12);
		test_expr("v1 or v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr13);
		test_expr("v1 and v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr14);
		test_expr("abs(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr15);
		test_expr("sqrt(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr16);
		test_expr("exp(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr17);
		test_expr("log(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr18);
		test_expr("log10(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr19);
		test_expr("sin(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr20);
		test_expr("sinh(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr21);
		test_expr("asin(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr22);
		test_expr("cos(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr23);
		test_expr("cosh(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr24);
		test_expr("acos(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr25);
		test_expr("tan(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr26);
		test_expr("tanh(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr27);
		test_expr("atan(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr28);
		test_expr("ceil(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr29);
		test_expr("floor(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr30);
		test_expr("isnan(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr31);
		test_expr("isinf(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr32);
		test_expr("sgn(v1)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr33);
		test_expr("atan2(v1, v2)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr34);
		test_expr("v1 ** v2", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr35);
		test_expr("maximum(v1, v2)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr36);
		test_expr("minimum(v1, v2)", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr37);
		test_expr("v3 if v1 == v2 else v4", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr38);
		test_expr("cv1 + v1", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr39);
		test_expr("cs1 - v1", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr40);
		test_expr("cs1 * v1", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr41);
		test_expr("cv1 / v1", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr42);
		test_expr("v1 + v2 + v3 + v4", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr43);
		test_expr("3 * v1 + cs1 * v2 + v3 + 2.5 * v4", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr44);
		test_expr("[v2, v2, v2] @ v1 + v3", block_sizes[i], "TEST_" + std::to_string(id_counter++)  + "_" + std::to_string(block_sizes[i]), file, &expr45);
	}
}
